...
-- Seq Scan(연속적인) on large_customers (cost=0.00... 3746.00 rows=10013 width=159)
-- 실제 시간(actual time=0.015..9.704 rows=10045 loops=1)
-- filter: (customer_type = 'VIP'::text)
-- Rows Removed by Filter: 89955
-- Planning Time: 0.073 ms
-- Execution Time: 9.985 ms
-- 인덱스 없고 / 테이블 대부분의 행을 읽어야 하고 / 순차 스캔이 빠를때
